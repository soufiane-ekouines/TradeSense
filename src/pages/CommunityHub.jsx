...
const Button = ({ children, className, variant = 'primary', onClick, ...props }) => {
    const base = "px-4 py-2 rounded-xl font-medium transition-all active:scale-[0.98] disabled:opacity-50";
    const variants = {
        primary: "bg-blue-600 text-white hover:bg-blue-500 shadow-[0_4px_15px_rgba(37,99,235,0.3)]",
